...
public class HomePage {
   ...
   /* // Метод для проверки видимости кнопки "Интернет-банк"
...
/*    // Метод для поиска по сайту
  ...
  /*  // Метод для проверки видимости результатов поиска
  ...
  /*  // Метод для проверки видимости номера горячей линии
    public boolean isHotlineNumberVisible() {
        try {
            WebElement hotlineNumber = driver.findElement(By.xpath("//span[contains(text(),'Горячая линия')]"));
            return hotlineNumber.isDisplayed();
        } catch (Exception e) {
            return false;
        }
    }*/

  /*  // Метод для открытия пунктов меню
    ...
    public void openContactsPage() {
        openMenuItem("Контакты");
    }*/
/*
    // Метод для перехода на страницу "Кредитные карты"
    public void openCreditCardsPage() {
        openMenuItem("Кредитные карты");
    }

    // Метод для перехода на страницу "Тарифы"
    public void openTariffsPage() {
        openMenuItem("Тарифы");
    }*/
